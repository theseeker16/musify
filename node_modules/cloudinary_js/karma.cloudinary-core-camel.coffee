...
module.exports = (config) ->
  config.set
    ...
    files: [
      ...
      'test/spec/spec-helper-camel.js'
      'test/spec/cloudinary-spec-camel.js'
      'test/spec/transformation-spec-camel.js'
      'test/spec/tagspec-camel.js'
      'test/spec/videourlspec-camel.js'
      'test/spec/chaining-spec-camel.js'
      'test/spec/layer-spec-camel.js'
      'test/spec/responsive-core-spec-camel.js'
