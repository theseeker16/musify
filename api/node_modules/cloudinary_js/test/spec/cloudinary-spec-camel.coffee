describe 'Cloudinary', ->
  ...
  beforeEach ->
    if jQuery?
      $.cloudinary = new (cloudinary.CloudinaryJQuery)(cloudName: 'test123')
      cl = $.cloudinary
      fixtureContainer = $('<div id="fixture" " >')
      fixtureContainer.appendTo 'body'
    else
      cl = new cloudinary.Cloudinary(cloudName: 'test123')
  ...
  it 'should allow overriding cloud_name in options', ->
    test_cloudinary_url 'test', { cloudName: 'test321' }, protocol + '//res.cloudinary.com/test321/image/upload/test', {}
  ...
  it 'should not add cloud_name if private_cdn and not secure', ->
    test_cloudinary_url 'test', { privateCdn: true }, protocol + '//test123-res.cloudinary.com/image/upload/test', {}
  ...
  it 'should use resource_type from options', ->
    test_cloudinary_url 'test', { resourceType: 'raw' }, protocol + '//res.cloudinary.com/test123/raw/upload/test', {}
  ...
  it 'should support new cdn_subdomain format', ->
    test_cloudinary_url 'test', { cdnSubdomain: true }, protocol + '//res-2.cloudinary.com/test123/image/upload/test', {}
  ...
  it 'should disallow urlSuffix in non upload types', ->
    expect(->
      cl.url 'test',
        urlSuffix: 'hello'
        privateCdn: true
  ...
  it 'should disallow urlSuffix with / or .', ->
    expect(->
      cl.url 'test',
  ...
  it 'should support urlSuffix for privateCdn', ->
    test_cloudinary_url 'test', {
      urlSuffix: 'hello'
      privateCdn: true
  ...
  it 'should support globally set use_root_path for private_cdn', ->
    ...
    test_cloudinary_url 'test', { privateCdn: true }, protocol + '//test123-res.cloudinary.com/test', {}
    delete cl.config().use_rootPath
